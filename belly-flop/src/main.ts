...
let ntes = [A3, C4, G4, A3, E4, B4, A3, D4, A4, A3]
let pttns = ['303', '10101', '123123', '321321']

let pttn = [...Array(30).keys()].flatMap(_ => pttns[_%pttns.length].split(''))
...
class Aa {
  ...
  static init() {
    ...
    const sfx = () => {
      ...
      ;[at, dcy, sus, rels] = [at, dcy, sus, rels].map(_ => _ / 2)
